...
GS_Forest = pickle.load(open(r'C:\Users\jrpgo\OneDrive - Rigor Consultoria e Gestão, SA\Pessoal\Python\Stocks\Random Forest.sav', 'rb'))

# Export results
prediction_perce = GS_Forest.predict_proba(data)[:,0]
df_Total["Prob"]=prediction_perce
